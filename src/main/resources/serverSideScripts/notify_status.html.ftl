                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   <div style="font-size: 22px; padding-bottom: 4px;">
                                                         Please note that TOPS ${args.TOPSNumber} has been ${args.TOPSStatus}
                                                   </div>
                                                </td>
                                             </tr>
                                          </table>
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td>
                                                                     <table cellpadding="2" cellspacing="0" border="0">
                                                                        <tr>
                                                                           <td><b>${args.docName}</b></td>
                                                                        </tr>
                                                                        <tr>
                                                                           <td>Click on this link to go to the document:</td>
                                                                        </tr>
                                                                        <tr>
                                                                           <td>
                                                                              <a href="${shareUrl}/page/site/reda-tops/document-details?nodeRef=workspace://SpacesStore/${args.docId}">
																			  ${shareUrl}/page/site/reda-tops/document-details?nodeRef=workspace://SpacesStore/${args.docId}</a>
                                                                           </td>
                                                                        </tr>
                                                                     </table>
                                                                  </td>
